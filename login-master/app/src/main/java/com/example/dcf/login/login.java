...
public class login extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(UserData.getInstance(this).isloggedin()){
            finish();
            startActivity(new Intent("gameactivity"));
            return;
        }
        ...
        if(email.matches(regex)){
            ...
            StringRequest sr1 = new StringRequest(Request.Method.POST, "https://vammuvamsi64.000webhostapp.com", new Response.Listener<String>() {
                ...
                try {
                    ...
                    if(o.getBoolean("logerr")){
                        Toast.makeText(getApplicationContext(), o.getString("logg"), Toast.LENGTH_LONG).show();

                    }else{
                        Toast.makeText(getApplicationContext(), o.getString("logg"), Toast.LENGTH_LONG).show();
                        Toast.makeText(getApplicationContext(), o.getString("name"), Toast.LENGTH_LONG).show();
                        UserData.getInstance(getApplicationContext()).userlogin(o.getString("useremail"),o.getString("name"));
                        finish();
                        startActivity(new Intent("gameactivity"));
                    }
