...
public class BouncingBall extends View {
    ...
    public BouncingBall(Context context,int x,int y) {
        ...
        for(int i =0;i<150;i++){
            ...
            BGObjects o = new BGObjects(x,y, 1);
            objs.add(o);
        ...
        for(int j =0;j<40;j++){
            ...
            Obstacles ob = new Obstacles(x,y,400+j*400,2);
            obst.add(ob);
        }
...
//        }
        ...
        if(!b && ballspeedx ==0){
            ...
            canvas.drawText("GAME OVER",xmax/2-200,ymax/2,paint);
        ...
        if(b){
            ...
            if(ballspeedx ==0){
                ...
                for(int i =0;i<150;i++){
                    ...
                    BGObjects o = new BGObjects(xmax,ymax, 1);
                    objs.add(o);
                ...
                for(int j =0;j<40;j++){
                    ...
                    Obstacles ob = new Obstacles(xmax,ymax,400+j*400,2);
                    obst.add(ob);
                }
    ...
    public void update(){
        ballspeedy= ballaccy + ballspeedy;
